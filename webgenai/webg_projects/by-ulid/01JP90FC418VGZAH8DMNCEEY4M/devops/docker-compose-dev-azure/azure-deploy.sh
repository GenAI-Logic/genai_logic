...
projectname="01jp90fc418vgzah8dmnceey4m"  # lower case, only
resourcegroup="01jp90fc418vgzah8dmnceey4m_rg"
...
# git clone https://github.com/apilogicserver/01jp90fc418vgzah8dmnceey4m.git
# cd 01jp90fc418vgzah8dmnceey4m
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name 01jp90fc418vgzah8dmnceey4m --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
