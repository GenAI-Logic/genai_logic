...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI_AUTHENTICATION = 'sqlite:////Users/val/dev/ApiLogicServer/ApiLogicServer-dev/build_and_test/ApiLogicServer/samples/tutorial/3. Logic/database/authentication_db.sqlite'
